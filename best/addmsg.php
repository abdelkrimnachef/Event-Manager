...
My princess message	 <br>		
matnsaych takatbili asmk bch na3ref chkon ba3to <3 
</span>
...
<?php 
    if(isset($_POST['submit'])){
        ...
        $qst = $_POST['qst'];
        $insert_qst = "insert into best_messages (msg) value ('$qst')";
            
        $run_qst = mysqli_query($con,$insert_qst);
        if($run_qst){
            echo " <script>alert(' your message has been succsefully inserted')</script> ";

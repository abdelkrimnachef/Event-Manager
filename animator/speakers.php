...
Speakers				</span>
                ...
                <div><!-- table-responsive begin -->
                    <table border="solid" width="100%"  ><!-- table table-striped table-bspeakered table-hover begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                while($row_speaker=mysqli_fetch_array($run_speakers)){
                                    
                                    $id = $row_speaker['id'];
                                    $name = $row_speaker['speaker'];
                    ...
                    </table><!-- table table-striped table-bspeakered table-hover finish -->
